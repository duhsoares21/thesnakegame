...
### Supported on 64-bit Windows Only 
...
- DirectX June 2010 is required to play the game; DirectX is available as a separate download on the [releases page](https://github.com/duhsoares21/thesnakegame/releases).
